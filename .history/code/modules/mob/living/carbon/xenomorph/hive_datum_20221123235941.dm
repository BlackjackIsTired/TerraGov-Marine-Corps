...
/datum/hive_status/proc/update_tier_limits()
	...
	tier3_xeno_limit = max((HUMAN_LIFE_ON_GROUND_WEIGHT + HUMAN_LIFE_WEIGHT_SHIPSIDE) / 3)
	tier2_xeno_limit = max((HUMAN_LIFE_ON_GROUND_WEIGHT + HUMAN_LIFE_WEIGHT_SHIPSIDE) / 2)
