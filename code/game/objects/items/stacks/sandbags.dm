...
/obj/item/stack/sandbags/attack_self(mob/living/user)
	...
	create_object(user, new/datum/stack_recipe("sandbag barricade", /obj/structure/barricade/sandbags, 5, time = building_time * BARRICADE_BUILDING_TIME_MULT, max_per_turf = STACK_RECIPE_ONE_DIRECTIONAL_PER_TILE, on_floor = TRUE), 1)
