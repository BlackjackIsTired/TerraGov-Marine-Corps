...
#define SLOWDOWN_ARMOR_HEAVY 0.85
#define SLOWDOWN_ARMOR_VERY_HEAVY 1.05
...
#define STAGGER_DAMAGE_MULTIPLIER 0 //-50% damage dealt by the staggered target after all other mods.
