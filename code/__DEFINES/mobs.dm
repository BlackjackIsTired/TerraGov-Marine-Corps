...
#define PAIN_REDUCTION_VERY_HEAVY -35 //tramadol
#define PAIN_REDUCTION_SUPER_HEAVY -50 //oxycodone


#define PAIN_REACTIVITY 0.1


//Nutrition

#define NUTRITION_STARVING -999
#define NUTRITION_HUNGRY -999
#define NUTRITION_WELLFED 0
...
#define XENO_TIER_MINION_T1 "Minion T1"
...
GLOBAL_LIST_INIT(xenotiers, list(XENO_TIER_MINION, XENO_TIER_MINION_T1, XENO_TIER_MINION_T2, XENO_TIER_MINION_T3, XENO_TIER_ZERO, XENO_TIER_ONE, XENO_TIER_TWO, XENO_TIER_THREE, XENO_TIER_FOUR))
GLOBAL_LIST_INIT(tier_as_number, list(XENO_TIER_MINION = -4, XENO_TIER_MINION_T1 = -3, XENO_TIER_MINION_T2 = -2, XENO_TIER_MINION_T3 = -1, XENO_TIER_ZERO = 0, XENO_TIER_ONE = 1, XENO_TIER_TWO = 2, XENO_TIER_THREE = 3, XENO_TIER_FOUR = 4))
...
#define XENO_SLOWDOWN_REGEN 0.8
...
#define RAVAGER_RAGE_ENDURE_INCREASE_PER_SLASH			0 SECONDS //The amount of time each slash during Super Rage increases Endure's duration
...
#define STANDARD_SLOWDOWN_REGEN 1.2
